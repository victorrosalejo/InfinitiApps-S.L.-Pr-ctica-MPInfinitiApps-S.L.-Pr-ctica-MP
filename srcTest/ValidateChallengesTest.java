...
public class ValidateChallengesTest {
    ...
    public void testValidateChallenges() {
        ...
        String[] entradas = {"1", user2.getRegisterNumber(),"1", "2"};
        ...
        databaseP.put(user2.getRegisterNumber(), challengelist);
        ...
        assertEquals(aux2.get(user2.getRegisterNumber()).size(),challengelist.size()-1);

        String[] entradas2 = {user2.getRegisterNumber(),"0", "1","0","salir","salir"};
        ...
        // Assert that the challenges are now validated
        assertTrue(aux2.get(user2.getRegisterNumber()).get(0).isValid());
